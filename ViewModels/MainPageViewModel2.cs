    ...
    public class MainPageViewModel2 : BaseClass
    {
        ...
        public FileData SelectedFile
        {
            ...
            set
            {
                ...
                if (this._selectedFile != null && this._selectedFile.Type == FileTypes.Program)
                    Task.Run(async () => await Task.Run(() => this.SelectedRobot.Item2.SelectProgramm(this._selectedFile.Name)));
            }
        }
