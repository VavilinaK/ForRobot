...
class CoordTemplates:
    ...
    def search_template_left_start(self):
        ...
        's2':(np.array([-d_s1, -60, 60]), np.array([169, 40, 120]), 20, 29),
        't2':(np.array([-d_s1, 0, 60]), np.array([169, 40, 120]), 20, 29),
        's3v1':(np.array([60 + l_r1, -60, 50]), np.array([-169, 40, 120]), 20, 29),
        's3v2':(np.array([60 + l_r1, 10, 50]), np.array([-169, 40, 120]), 20, 29),
        't3':(np.array([l_r1, 10, 50]), np.array([-169, 40, 120]), 20, 29),
    ...
    def search_template_left_end(self):
        ...
        's2':(np.array([d_s2, -60, 60]), np.array([169, 40, 60]), 20, 29),
        't2':(np.array([d_s2, 0, 60]), np.array([169, 40, 60]), 20, 29),
        's3v1':(np.array([-60 - l_r2, -60, 50]), np.array([-169, 40, 30]), 20, 29),
        's3v2':(np.array([-60 - l_r2, 10, 50]), np.array([-169, 40, 30]), 20, 29),
        't3':(np.array([-l_r2, 10, 50]), np.array([-169, 40, 30]), 20, 29),
        'departure':(np.array([-100 - l_r2, -60, h+100]), np.array([-169, 50, 30]), 20, 29),
        }
    ...
    def search_template_right_start(self):
        ...
        's2':(np.array([-d_s1, 60, 60]), np.array([169, 40, -120]), 20, 53),
        't2':(np.array([-d_s1, 0, 60]), np.array([169, 40, -120]), 20, 53),
        's3v1':(np.array([60 + l_r1, 60, 50]), np.array([-169, 40, -120]), 20, 53),
        's3v2':(np.array([60 + l_r1, -10, 50]), np.array([-169, 40, -120]), 20, 53),
        't3':(np.array([l_r1, -10, 50]), np.array([-169, 40, -120]), 20, 53),
    ...
    def search_template_right_end(self):
        ...
        's2':(np.array([d_s2, 60, 60]), np.array([169, 40, -60]), 20, 53),
        't2':(np.array([d_s2, 0, 60]), np.array([169, 40, -60]), 20, 53),
        's3v1':(np.array([-60 - l_r2, 60, 50]), np.array([-169, 40, -45]), 20, 53),
        's3v2':(np.array([-60 - l_r2, -10, 50]), np.array([-169, 40, -45]), 20, 53),
        't3':(np.array([-l_r2, -10, 50]), np.array([-169, 40, -45]), 20, 53),
        'departure':(np.array([-100 - l_r2, 60, h+100]), np.array([-169, 40, -45]), 20, 53),
    }
