...
arcon_dat_template = '''
DECL stArcDat_T WDAT{0}={{Strike {{JobModeId[] "Job Mode",ParamSetId[] "Set1",StartTime 0.0,PreFlowTime 0.0,Channel1 {13},Channel2 0.0,Channel3 0.0,Channel4 0.0,Channel5 0.0,Channel6 0.0,Channel7 0.0,Channel8 0.0,PurgeTime 0.0}},Weld {{JobModeId[] "Job Mode",ParamSetId[] "Set2",Velocity {14:.4f},Channel1 {13},Channel2 0,Channel3 0.0,Channel4 0.0,Channel5 0.0,Channel6 0.0,Channel7 0.0,Channel8 0.0}},Weave {{Pattern #Triangle,Length {15:.1f},Amplitude {16:.1f},Angle 0.0,LeftSideDelay 0.0,RightSideDelay 0.0}},Advanced {{IgnitionErrorStrategy 1,WeldErrorStrategy 1,SlopeOption #None,SlopeTime 0.0,SlopeDistance 0.0,OnTheFlyActiveOn FALSE,OnTheFlyActiveOff FALSE,OnTheFlyDistanceOn 0.0,OnTheFlyDistanceOff 0.0}},Track {{IsArcSenseEnabled TRUE,ControlEnabled TRUE,KeepOffset TRUE,TeachNew FALSE,FindSeamMiddle TRUE,TrackingDelay 0.2,ControlSensibility 25.0,MaxDeviation 100,ControlSensibilityHeight 25.0,Bias 0.0,WeaveOffset 0.0,HeightCorrValue 0.0}}}}
DECL stArcDat_T W{0}={{Strike {{SeamName[] " ",SeamNumber -1}},Advanced {{BitCodedRobotMark 0}}}}
DECL E6POS X{0}={{X {2},Y {3},Z {4},A {5:.3f},B {6:.3f},C {7:.3f},S {8},T {9},E1 {10},E2 {11},E3 {12},E4 0,E5 0,E6 0}}
DECL FDAT F{0}={{TOOL_NO 1,BASE_NO 10,IPO_FRAME #BASE,POINT2[] " "}}
...
PDAT_ACT={{VEL 100.0,ACC 10.0,APO_DIST 10.0,GEAR_JERK 50.0000,EXAX_IGN 0}}
...
def_go_start_template = '''

DEF go_start()
;FOLD GO_START
DECL E6AXIS XPSTART
;XPSTART = {{A1 -90.0,A2 0.0,A3 -130.0,A4 0.0,A5 -50.0,A6 -90.0,E1 0,E2 0.0,E3 {0},E4 0.0,E5 0.0,E6 0.0}}
DECL E6POS XPSTART={{X {0},Y {1},Z {2},A {3},B {4},C {5},S {6},T {7},E1 {8},E2 {9},E3 {10},E4 0,E5 0,E6 0}}
ptp $axis_act
XPSTART.E2 = $axis_act.E2
XPSTART.X = XPSTART.X + ($axis_act.E1 - XPSTART.E1)
XPSTART.E1 = $axis_act.E1
PDAT_ACT={{VEL 100.0,ACC 10.0,APO_DIST 10.0,GEAR_JERK 50.0000,EXAX_IGN 0}}
FDAT_ACT={{TOOL_NO 1,BASE_NO 10,IPO_FRAME #BASE,POINT2[] " "}}
BAS(#PTP_PARAMS,100.0)
SET_CD_PARAMS (0)
...
;FOLD GO_END
DECL E6AXIS XPEND
XPEND = {{A1 0.0,A2 0.0,A3 -130.0,A4 0.0,A5 -50.0,A6 -90.0,E1 {0},E2 0.0,E3 -350.0,E4 0.0,E5 0.0,E6 0.0}}
ptp $axis_act
XPEND.E2 = $axis_act.E2
XPEND.E3 = $axis_act.E3
XPEND.A1 = $axis_act.A1
XPEND.A2 = $axis_act.A2
XPEND.A3 = $axis_act.A3
XPEND.A4 = $axis_act.A4
XPEND.A5 = $axis_act.A5
XPEND.A6 = $axis_act.A6
