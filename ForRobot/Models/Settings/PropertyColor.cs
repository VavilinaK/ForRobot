...
namespace ForRobot.Models.File3D
{
    ...
    public class PropertyColor
    {
        ...
        /// <summary>
        /// Возвращает цвет элемента из класса <see cref="ForRobot.Models.File3D.Colors"/>
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Задаёт цвет свойству элемента в классе <see cref="ForRobot.Models.File3D.Colors"/>
        /// </summary>
