        ...
        private Bitmap GetTextPlita(Bitmap bitmap)
        {
            using (Graphics graphics = Graphics.FromImage(bitmap))
            {
                ...
                using (Font font = new Font("Lucida Console", 18, System.Drawing.FontStyle.Regular))
                {
                    ...
                    graphics.DrawString(SearchOffsetStart.ToString(),
                                        FontLibr.FindFont(graphics, SearchOffsetStart.ToString(), new System.Drawing.Size(60, 25), font),
                                        new SolidBrush(Color.Black),
                                        new PointF(240, 40),
                                        stringFormat2);

                    graphics.DrawString(SearchOffsetEnd.ToString(),
                                        FontLibr.FindFont(graphics, SearchOffsetEnd.ToString(), new System.Drawing.Size(60, 25), font),
                                        new SolidBrush(Color.Black), 
