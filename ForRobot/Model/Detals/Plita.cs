...
namespace ForRobot.Model.Detals
{
    public class Plita : Detal
    {
        ...
        /// </summary>
        [JsonIgnore]
        public override string JsonForSave { get => JsonConvert.SerializeObject(this.Save(), _jsonSettings).Replace(ScoseTypes.SlopeLeft, this.ScoseType); }
        ...
        {
            get => _ribsCollection ?? (_ribsCollection = FillRibsCollection());
            set
            {
        ...
        public string ScoseType
        {
            ...
            set
            {
                ...
                if (!Equals(this._scoseType, ScoseTypes.Rect))
                    this.DiferentDistance = false;
        ...
        {
            get => Equals(this.ScoseType, ScoseTypes.Rect) ? this._diferentDistance : false;
            set
            {
        ...
        //private ObservableCollection<Rib> FillRibsCollection()
        //{
        //    Rib rib;
        ...
        //        rib.Change += this.Change;
        //        ribs.Add(rib);
        //    }
        //    //ObservableCollection<Rib> r = new ObservableCollection<Rib>(ribs);
        //    //r.CollectionChanged += new System.Collections.Specialized.NotifyCollectionChangedEventHandler(Change);
        //    return new ObservableCollection<Rib>(ribs);
        //}
