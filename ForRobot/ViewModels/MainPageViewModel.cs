...
namespace ForRobot.ViewModels
{
    public class MainPageViewModel : BaseClass
    {
        ...
        //public ObservableCollection<Rib> RibsCollection
        //{
        //    get => ((Plita)this.DetalObject).RibsCollection;
        //    set
        //    {
        //        ((Plita)this.DetalObject).RibsCollection = value;
        //        RaisePropertyChanged(nameof(this.RibsCollection));
        //    }
        //}
        ...
        //{
        //    get;set;
        //    //get => ((Plita)this.DetalObject).RibsCollection[0].Distance;
        //    //set
        //    //{
        //    //    for(int i=0; i< ((Plita)this.DetalObject).SumReber-1; i++)
        //    //    {
        //    //        ((Plita)this.DetalObject).RibsCollection[i].Distance = value;
        //    //    }
        //    //    RaisePropertyChanged(nameof(this.DistanceBetweenRibs));
        //    //}
        //}
            ...
            get
            {
                return _standartParametrsCommand ??
                    (_standartParametrsCommand = new RelayCommand(obj =>
                    {
                        ...
                        {
                            this.DetalObject = new Plita(DetalType.Plita) { ScoseType = ((Plita)this.DetalObject).ScoseType };
                            ((Plita)this.DetalObject).RibsCollection.ItemPropertyChanged += (o, e) => this.SaveDetal();
                        }
        ...
        /// <summary>
        /// Изменения свойств отдельных рёбер
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        //    {
        //        foreach (Rib item in e.OldItems)
        //        {
        //            item.Change -= this.ChangeProperiesDetal;
        //        }
        //    }
        //    else if (e.Action == System.Collections.Specialized.NotifyCollectionChangedAction.Add)
        //    {
        //        foreach (Rib item in e.NewItems)
        //        {
        //            item.Change += ChangeProperiesDetal;
        //        }
        //    }
        //}

        //private void SpringDataOnPropertyChanged(object sender, PropertyChangedEventArgs propertyChangedEventArgs) => SaveDetal();
