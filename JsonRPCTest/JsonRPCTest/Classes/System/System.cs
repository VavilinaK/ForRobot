...
namespace JsonRPCTest.Classes.System
{
    public class System : JsonRpcNamespace
    {
        ...
        public bool CanShutdown
        {
            get
            {
                this.client.LogMessage("System.CanShutdown");
        ...
        public bool CanSuspend
        {
            get
            {
                this.client.LogMessage("System.CanSuspend");
        ...
        public bool CanHibernate
        {
            get
            {
                this.client.LogMessage("System.CanHibernate");
        ...
        public bool CanReboot
        {
            get
            {
                this.client.LogMessage("System.CanReboot");
        ...
        internal System(JsonRpcClient client)
            : base(client)
        { }
        ...
        {
            this.client.LogMessage("System.Shutdown()");

            if (!this.CanShutdown)
            {
                this.client.LogErrorMessage("Cannot shutdown computer running App.");
        ...
        public bool Suspend()
        {
            this.client.LogMessage("System.Suspend()");

            if (!this.CanSuspend)
            {
                this.client.LogErrorMessage("Cannot suspend computer running App.");
        ...
        {
            this.client.LogMessage("System.Hibernate()");

            if (!this.CanHibernate)
            {
                this.client.LogErrorMessage("Cannot hibernate computer running App.");
        ...
        public bool Reboot()
        {
            this.client.LogMessage("System.Reboot()");

            if (!this.CanReboot)
            {
                this.client.LogErrorMessage("Cannot reboot computer running App");
        ...
        {
            this.client.LogMessage("System.GetInfoLabels(" + string.Join(", ", labels) + ")");
        ...
        {
            this.client.LogMessage("System.GetInfoLabel(" + label + ")");
        ...
        {
            this.client.LogMessage("System.GetInfoBooleans(" + string.Join(", ", labels) + ")");
        ...
        {
            this.client.LogMessage("System.GetInfoBoolean(" + label + ")");
